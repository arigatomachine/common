 ...
 */
Validate.prototype.readSchemas = function () {
  var self = this;
 ...
 */
Validate.prototype.readProperties = function (schemaPath) {
 ...
 */
Validate.prototype._requireSchema = function (schemaPath) {
 ...
 */
Validate.extractErrors = function (errs, stopRecurse) {
  var messages = [];
  var hasErrors = false;
  ...
  var subErrors = _.filter(_.map(errs, function(err) {
    return err.subErrors;
 ...
 */
Validate.findPropsWithError = function (result, code) {
 ...
 */
Validate.middleware = function (schemaPath) {
